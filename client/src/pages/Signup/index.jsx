...
const Signup = () => {
  ...
  // Auth functions
  const {createUser, updateUserProfile, loginWithGoogle, loginWithGithub, setIsUserLoading} =
    useAuth();
  ...
  const handleRegister = async (data) => {
    ...
    try {
      ...
      // Update user profile
      await updateUserProfile(name, photoResponse?.secure_url);
  ...
  return (
    <main className="w-full min-h-screen flex flex-col items-center justify-center px-4 pb-10">
      <div className="max-w-sm md:max-w-xl w-full space-y-5">
